        ...
        <div className="relative z-10 space-y-12">
          ...
          <div className="space-y-6">
            <h2 className="text-5xl xl:text-6xl font-black leading-tight tracking-tight">
              Start Your <br />
              <span className="text-nanobanana italic font-serif font-medium">Transformation.</span>
            </h2>
            <p className="text-xl opacity-70 max-w-md leading-relaxed font-medium">
              Get instant access to over 500+ clinical yoga poses and personalized flows.
            </p>
          </div>

          <div className="grid gap-6">
            {[
              { icon: <CheckCircle2 className="text-nanobanana" />, text: "Free account forever" },
              { icon: <ShieldCheck className="text-rose" />, text: "AI-powered joint alignment" },
              { icon: <Sparkles className="text-blue-300" />, text: "Clinical-grade movement data" }
            ].map((item, i) => (
        ...
        <div className="w-full max-w-md animate-in fade-in slide-in-from-right duration-700 space-y-8">
          ...
          <div className="text-center pt-4">
            <p className="text-sm text-[#6B705C] font-medium">
              Already a member?{" "}
              <Link href="/sign-in" className="text-rose font-black hover:underline tracking-tight">
                Log in here
              </Link>
            </p>
          </div>
